...
namespace Microsoft.Windows.PowerShell.ScriptAnalyzer.Commands
{
  ...
  public class InvokeScriptAnalyzerCommand : PSCmdlet, IOutputWriter
  {
    ...
    protected override void BeginProcessing()
    {
      ...
      string? fileSystemProviderPath = null;
      try
      {
        try
        {
          fileSystemProviderPath = CurrentProviderLocation("FileSystem")?.ProviderPath;
        }
        ...
        var settingsObj = PSSASettings.Create(
            settings,
            processedPaths == null || processedPaths.Count == 0 ? fileSystemProviderPath : processedPaths[0],
            this,
